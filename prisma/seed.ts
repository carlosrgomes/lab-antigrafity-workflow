...
const GAMES_TO_SEED: IGameSeed[] = [
  ...
  },
  {
    ...
    description:
      'The open-world masterpiece set in the fictional state of San Andreas.',
    price: 49.9,
    rarity: 'Common',
    console: 'PS2',
    stock: 10,
  ...
  },
  {
    ...
    description:
      "Leon S. Kennedy rescues the President's daughter in a spooky European village.",
    price: 59.9,
    rarity: 'Common',
    console: 'PS2',
    stock: 8,
  ...
  },
  {
    ...
    description:
      'Wander must travel across a vast land to defeat sixteen massive beasts.',
    price: 99.9,
    rarity: 'Rare',
    console: 'PS2',
    stock: 5,
  ...
  },
  {
    title: 'God of War II',
    description:
      'Kratos battles through the mythological underworld to change his fate.',
    price: 59.9,
    rarity: 'Common',
    console: 'PS2',
    stock: 7,
  ...
  },
  {
    title: 'Silent Hill 2',
    description:
      'James Sunderland travels to the fog-shrouded town of Silent Hill after receiving a letter from his deceased wife.',
    price: 149.9,
    rarity: 'UltraRare',
    console: 'PS2',
    stock: 3,
